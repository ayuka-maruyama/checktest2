        ...
        @csrf
            <table class="confirm-table">
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__data">{{ $contacts['first_name'] }}&ensp;{{ $contacts['last_name'] }}</td>
                    <!-- 非表示要素で$contactsに代入されてるデータを取り出す -->
                ...
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__data">{{ $category->content }}</td>
                    <input type="hidden" name="category_id" value="{{ $category->id }}">
                </tr>

                <tr class="confirm-table__row">
                    <th class="confirm-table__label">お問い合わせ内容</th>
                    <td class="confirm-table__data-detail">{{ $contacts['detail'] }}</td>
